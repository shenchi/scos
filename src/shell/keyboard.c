...
unsigned long translate_scancode(unsigned long scancode);

unsigned char kbuf[299];
...
void init_keyboard(void){
	...
	kbuf[0]=0xFF;
	__asm__("mov $0x302,%%eax;int $0x40"::"b"((unsigned long)(&kbuf[0])));
}
